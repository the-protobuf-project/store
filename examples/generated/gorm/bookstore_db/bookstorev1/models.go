...
type Book struct {
	...
	Genre Genre `gorm:"column:genre;not null;default:'FICTION';check:chk_books_genre,genre IN ('FICTION','NON_FICTION','SCI_FI','FANTASY')" json:"genre" validate:"required" telemetry:"trace:book.genre"`
