...
// Package profiledb wires every model generated for the profile_db database
...
import (
	"example.com/test/gen/profile_db/profile"
...
//
//	if err := profiledb.Default.EnsureSchemas(db); err != nil {
//		log.Fatal(err)
//	}
//	if err := profiledb.Default.Migrate(db); err != nil {
//		log.Fatal(err)
//	}
...
// Default holds every model generated for the profile_db database. Attach it
...
//
//	profiledb.Default.Register(&MyModel{})
