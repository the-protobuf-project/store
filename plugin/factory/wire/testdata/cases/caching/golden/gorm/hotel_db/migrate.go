...
// Package hoteldb wires every model generated for the hotel_db database
...
import (
	"example.com/test/gen/hotel_db/hotel"
...
//
//	if err := hoteldb.Default.EnsureSchemas(db); err != nil {
//		log.Fatal(err)
//	}
//	if err := hoteldb.Default.Migrate(db); err != nil {
//		log.Fatal(err)
//	}
...
// Default holds every model generated for the hotel_db database. Attach it
...
//
//	hoteldb.Default.Register(&MyModel{})
