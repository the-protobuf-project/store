...
// Package licencedb wires every model generated for the licence_db database
...
import (
	"example.com/test/gen/licence_db/public"
...
//
//	if err := licencedb.Default.EnsureSchemas(db); err != nil {
//		log.Fatal(err)
//	}
//	if err := licencedb.Default.Migrate(db); err != nil {
//		log.Fatal(err)
//	}
...
// Default holds every model generated for the licence_db database. Attach it
...
//
//	licencedb.Default.Register(&MyModel{})
